...
/**
 * Public-facing validity check - used by the frontend to show a
 * "10% off applied" message at checkout before the booking is
 * actually created. Does not increment usage count; that only
 * happens when a booking is created with this coupon (Phase 6).
 */
