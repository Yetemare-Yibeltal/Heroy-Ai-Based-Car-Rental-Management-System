 ...
 * Example: toCSV([{ name: 'Aster', price: 38 }]) -> "name,price\nAster,38"
 */
...
/**
 * Streams a CSV file directly to the HTTP response with the
 * correct headers so the browser downloads it as a file.
 */
...
/**
 * Builds a simple tabular PDF report (used for invoices and admin
 * exports) and returns it as a Buffer, ready to save or stream.
 */
